...
class AnimalValidatorTest {
    ...
    @BeforeEach
    void setUp() {validator = new AnimalValidator();}
    ...
    class ValidateFullAnimal {
        ...
        void shouldThrowForBlankName() {
            ...
            Animal animal = new Animal("", "Cat", 3, true, LocalDate.now());
        ...
        void shouldThrowForBlankSpecies() {
            ...
            Animal animal = new Animal("Jasper", "", 10, true, LocalDate.now());
            assertThrows(IllegalArgumentException.class, () -> validator.validate(animal));
        }
        ...
        void shouldThrowForNegativeAge() {
            ...
            Animal animal = new Animal("Jasper", "Cat", -3, true, LocalDate.now());
            assertThrows(IllegalArgumentException.class, () -> validator.validate(animal));
